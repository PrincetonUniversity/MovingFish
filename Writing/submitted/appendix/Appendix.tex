...
\begin{figure}[h]
\centering
\includegraphics[width=2.9in]{../figures/rockfish_criticalh.pdf}
...
The line indicate the critical harvest fraction as a function of climate velocity on the x-axis. Model parameterized for black rockfish. }
 \end{figure}
  ...
  \begin{figure}[h]
 \centering
 \includegraphics[width=6.1in]{../figures/rockfisheqbiomass.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=6.1in]{../figures/compare_flucts.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=6.1in]{../figures/rockfish_sims.pdf}
