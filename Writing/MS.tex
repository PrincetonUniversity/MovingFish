...
%% A little confusing. First you say that the critical parameter for persistence is equivalent to the intrinsic growth rate, and then list a bunch of other parameters that are also important for determining it. 
