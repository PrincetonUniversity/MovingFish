...
persistence.  We measured the interaction between the stressors and we found low but positive 
synergy between the two stressors: harvesting aggravates the population's sensitivity to a shifting range.  We then found threshold rates of harvesting and of environmental shift such that more extreme harvesting or shift will drive the population extinct and studied how these critical parameters depend on the growth rate and dispersal behavior 
of the population.   
