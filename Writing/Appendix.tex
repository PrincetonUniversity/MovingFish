...
\end{align}
The recursive equation (\ref{recursive}) allows us to find the $m_n$ numerically and we then find the total equilibrium biomass by integrating $n^*(x)$ over space.
