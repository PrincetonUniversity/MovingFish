...
\begin{figure}[h]
\centering
\caption{ \label{crith_rockfish} Lines indicate the critical threshold for persistence as a function of harvesting rate on the y-axis and climate velocity as a fraction of the length of the viable patch on the x-axis from an approximated Gaussian dispersal kernel as parameterized for black rockfish. }
 \end{figure}
